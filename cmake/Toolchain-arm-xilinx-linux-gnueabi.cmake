...
if ("$ENV{XILINX_TOOLCHAIN_DIR}" STREQUAL "")
        message(FATAL_ERROR "XILINX_TOOLCHAIN_DIR not set")
else()
        set(XILINX_TOOLCHAIN_DIR $ENV{XILINX_TOOLCHAIN_DIR})
endif()
